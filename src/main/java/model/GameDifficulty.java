...
public enum GameDifficulty {
    EASY(9, 9, 10,6,2, 5),
    MEDIUM(13, 13, 40,7,3, 8),
    HARD(16, 16, 99,11,4, 12);
...
//
    private GameDifficulty(int rows, int cols, int mineCount,int questionCount, int surpriseCount, int activationCost) {
        this.rows = rows;
        this.cols = cols;
